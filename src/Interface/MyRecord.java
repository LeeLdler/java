...
public class MyRecord extends JFrame implements ActionListener{
	...
	public MyRecord(Client client)
	{
		...
		jl1 = new JLabel("语音发送功能的实现");
		jl1.setFont(myFont);
		jp1.add(jl1);
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowClosed(WindowEvent arg0) {
				client.closeMyRecord();
			}
		});
	...
	public void outplay(String path)
	{
		//将baos中的数据转换为字节数据
	...
	public void save()
	{
        ...
        try {	
        	...
        	file = new File(filePath.getPath()+"/"+name);      
